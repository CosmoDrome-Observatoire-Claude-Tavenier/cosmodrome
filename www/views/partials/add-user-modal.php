<div class="modal--container">
    <div class="modal">
        ...
        <form action="<?= $base_url ?>/users/add/confirm" method="POST">
            ...
            <input type="text" name="username" class="modal--input" placeholder="Nom d'utilisateur" required>
            <label for="password" class="modal--label">Mot de passe</label>
            <input type="password" name="password" class="modal--input" placeholder="Mot de passe" required>
