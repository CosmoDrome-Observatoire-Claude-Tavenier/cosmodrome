<div class="modal--container">
    <div class="modal">
        ...
        <form action="<?= $base_url ?>/users/modify-user/<?= $user['id'] ?>/confirm" method="POST">
            ...
            <input type="text" name="username" class="modal--input" value="<?= $user['username'] ?>">
            <label for="password" class="modal--label">Mot de passe</label>
            <input type="password" name="password" class="modal--input" placeholder="Nouveau mot de passe">
